      ...
      if (element.status == "upcoming") {
        ...
        if (element.tournamentType.toLowerCase() != "solo") {
          ...
          html2 += `  <div class="col-12 col-lg-5 order-1">
                        ...
                        <div class="form-row">
                          <div class="col-12 col-lg-10">
                            <label for="" class="form-label">Team Name</label>
                            <input type="text" id="team_name${count}" class="form-control form-control-sm w-100 mb-3">
                          </div>
                        </div>
                        <h5>Player Name</h5>
                        <div class="form-group row">
        ...
        html2 += `<div class="col-12 col-lg-7 text-center order-2 mb-3">
                      ...
                      <h5 class="text-success slots">
                        Slots Free : 
                        <span class=""><span id="slot_value${count}">${element.slotsAvailable}</span><span class="ml-2 hurry">Hurry Up!</span></span>
                      </h5>
                      <script>
                        $(document).ready(function(){
                          var slot_free = parseInt($("#slot_value${count}").text(), ${element.slots});
                          if (slot_free < ${parseInt(element.slotsAvailable/element.slots)*100}) {
